...
def  geocentriques_vers_Geodesiques():
    ...
    Bouton6= Button(Mafenetre2, text = 'visualiser', command = openweb4,  bg='#3498DB', fg='#FDFEFE',font=('Ink Free', 9, 'bold'))
    Bouton6.pack(side=BOTTOM)
